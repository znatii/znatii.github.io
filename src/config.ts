...
export const SITE: Site = {
  title: 'ZNATI',
  description:
    'Blog personal de ZNATI sobre CTFs, criptografía, writeups y seguridad informática.',
  website: 'https://znatii.github.io/',
  lang: 'es',
  base: '/',
  author: 'znati',
